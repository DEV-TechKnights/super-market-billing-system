...
if($row = mysqli_fetch_array($result)){
 $cbal=$row['current_balance'];
	...
	if ($conn->query($sql) === TRUE) {
		...
		$sql2 = "INSERT INTO dealer_history_of_transaction(name,date,time,amount_paid,purchase_bill,liability_amount,bill) VALUES ('$dname', '$dte', '$hourMin', '$paid','$addbill', '$netbal','$imgloc')";
