<?php
 define ("filesplace","../staff/profile");
...
$sql = "INSERT INTO user_accounts (username, password, name, address, phone, profile,type)
VALUES ('$user', '$pass','$fname','$address','$mobile','$imgloc','$type')";
